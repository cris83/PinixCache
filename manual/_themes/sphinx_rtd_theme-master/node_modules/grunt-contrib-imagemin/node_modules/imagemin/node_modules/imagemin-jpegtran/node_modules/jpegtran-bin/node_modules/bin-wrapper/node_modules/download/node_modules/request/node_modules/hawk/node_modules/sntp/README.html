...
along with the roundtrip duration and clock offset. To adjust the local time to the NTP time, add the returned <cite>t</cite> offset
to the local time.</p>
<p>[![Build Status](<a class="reference external" href="https://secure.travis-ci.org/hueniverse/sntp.png)](http://travis-ci.org/hueniverse/sntp">https://secure.travis-ci.org/hueniverse/sntp.png)](http://travis-ci.org/hueniverse/sntp</a>)</p>
<p># Usage</p>
...
<dl class="docutils">
<dt>var options = {</dt>
<dd>host: &#8216;nist1-sj.ustiming.org&#8217;,  // Defaults to pool.ntp.org
port: 123,                      // Defaults to 123 (NTP)
resolveReference: true,         // Default to false (not resolving)
timeout: 1000                   // Defaults to zero (no timeout)</dd>
</dl>
<p>};</p>
...
<dt>if (err) {</dt>
<dd>console.log(&#8216;Failed: &#8216; + err.message);
process.exit(1);</dd>
</dl>
<p>}</p>
<p>console.log(&#8216;Local clock is off by: &#8216; + time.t + &#8216; milliseconds&#8217;);
process.exit(0);</p>
</div></blockquote>
...
<blockquote>
<div><p>console.log(offset);                    // New (served fresh)</p>
<p>// Request offset again</p>
<p>Sntp.offset(function (err, offset) {</p>
<blockquote>
<div>console.log(offset);                // Identical (served from cache)</div></blockquote>
<p>});</p>
</div></blockquote>
</div>
...
<blockquote>
<div>var now = Sntp.now();                   // With offset
Sntp.stop();</div></blockquote>
</div>
