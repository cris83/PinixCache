  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>&lt;no title&gt;</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../../../../../../../../../../../../../../../../../_sources/_themes/sphinx_rtd_theme-master/node_modules/grunt-contrib-imagemin/node_modules/imagemin/node_modules/imagemin-pngquant/node_modules/pngquant-bin/node_modules/bin-build/node_modules/download/node_modules/request/node_modules/http-signature/README.txt" rel="nofollow"> View page source</a>
...
var req = https.request(options, function(res) {</p>
<blockquote>
<div>console.log(res.statusCode);</div></blockquote>
<p>});</p>
<dl class="docutils">
<dt>httpSignature.sign(req, {</dt>
<dd>key: key,
keyId: &#8216;./cert.pem&#8217;</dd>
</dl>
<p>});</p>
...
<dl class="docutils">
<dt>var options = {</dt>
<dd>key: fs.readFileSync(&#8216;./key.pem&#8217;),
cert: fs.readFileSync(&#8216;./cert.pem&#8217;)</dd>
</dl>
<p>};</p>
<dl class="docutils">
<dt>https.createServer(options, function (req, res) {</dt>
<dd><p class="first">var rc = 200;
var parsed = httpSignature.parseRequest(req);
var pub = fs.readFileSync(parsed.keyId, &#8216;ascii&#8217;);
if (!httpSignature.verifySignature(parsed, pub))</p>
<blockquote>
<div>rc = 401;</div></blockquote>
<p class="last">res.writeHead(rc);
res.end();</p>
</dd>
</dl>
<p>}).listen(8443);
...
<p>## Installation</p>
<blockquote>
<div>npm install http-signature</div></blockquote>
<p>## License</p>
<p>MIT.</p>
<p>## Bugs</p>
