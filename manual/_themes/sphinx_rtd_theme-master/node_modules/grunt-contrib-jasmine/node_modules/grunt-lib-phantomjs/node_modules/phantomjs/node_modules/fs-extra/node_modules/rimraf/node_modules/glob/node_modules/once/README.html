  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>}</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../../../../../../../../../../../../../../../_sources/_themes/sphinx_rtd_theme-master/node_modules/grunt-contrib-jasmine/node_modules/grunt-lib-phantomjs/node_modules/phantomjs/node_modules/fs-extra/node_modules/rimraf/node_modules/glob/node_modules/once/README.txt" rel="nofollow"> View page source</a>
...
<dl class="docutils">
<dt>function load (file, cb) {</dt>
<dd>cb = once(cb)
loader.load(&#8216;file&#8217;)
loader.once(&#8216;load&#8217;, cb)
loader.once(&#8216;error&#8217;, cb)</dd>
</dl>
...
<p>To check whether you function has been called, use <cite>fn.called</cite>. Once the
function is called for the first time the return value of the original
function is saved in <cite>fn.value</cite> and subsequent calls will continue to
return this value.</p>
<p><a href="#id11"><span class="problematic" id="id12">``</span></a><a href="#id13"><span class="problematic" id="id14">`</span></a>javascript
var once = require(&#8216;once&#8217;)</p>
<dl class="docutils">
<dt>function load (cb) {</dt>
<dd><p class="first">cb = once(cb)
var stream = createStream()
stream.once(&#8216;data&#8217;, cb)
stream.once(&#8216;end&#8217;, function () {</p>
<blockquote>
<div>if (!cb.called) cb(new Error(&#8216;not found&#8217;))</div></blockquote>
<p class="last">})</p>
</dd>
</dl>
</div>
