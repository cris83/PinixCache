  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>})</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../../../../../../../../../../../_sources/_themes/sphinx_rtd_theme-master/node_modules/grunt-contrib-nodeunit/node_modules/nodeunit/node_modules/tap/node_modules/coveralls/node_modules/request/README.txt" rel="nofollow"> View page source</a>
...
<p>[![NPM](<a class="reference external" href="https://nodei.co/npm/request.png)](https://nodei.co/npm/request/">https://nodei.co/npm/request.png)](https://nodei.co/npm/request/</a>)</p>
...
<p><a href="#id29"><span class="problematic" id="id30">``</span></a><a href="#id31"><span class="problematic" id="id32">`</span></a>javascript
...
<p><a href="#id44"><span class="problematic" id="id45">``</span></a><a href="#id46"><span class="problematic" id="id47">`</span></a>javascript
...
<a href="#id48"><span class="problematic" id="id49">``</span></a><a href="#id50"><span class="problematic" id="id51">`</span></a></p>
...
<li><cite>followRedirect</cite> - follow HTTP 3xx responses as redirects (default: <cite>true</cite>)</li>
...
<p>## Examples:</p>
<dl class="docutils">
<dt><a href="#id52"><span class="problematic" id="id53">``</span></a><a href="#id54"><span class="problematic" id="id55">`</span></a>javascript</dt>
<dd><dl class="first docutils">
...
<p><a href="#id65"><span class="problematic" id="id66">``</span></a><a href="#id67"><span class="problematic" id="id68">`</span></a>javascript
var j = request.jar()
...
<p>OR</p>
<p><a href="#id70"><span class="problematic" id="id71">``</span></a><cite>javascript
...
<p><a href="#id73"><span class="problematic" id="id74">``</span></a><a href="#id75"><span class="problematic" id="id76">`</span></a>javascript
var j = request.jar()
request({url: &#8216;<a class="reference external" href="http://www.google.com">http://www.google.com</a>&#8216;, jar: j}, function () {</p>
<blockquote>
