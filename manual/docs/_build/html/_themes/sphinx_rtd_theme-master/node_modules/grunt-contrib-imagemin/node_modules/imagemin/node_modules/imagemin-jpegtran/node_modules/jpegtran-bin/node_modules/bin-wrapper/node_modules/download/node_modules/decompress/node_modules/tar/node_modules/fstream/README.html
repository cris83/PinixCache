...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <p>Like FS streams, but with stat on them, and supporting directories and
symbolic links, as well as normal files.  Also, you can use this to set
the stats on a file, even if you don&#8217;t change its contents, or to create
a symlink, etc.</p>
<p>So, for example, you can &#8220;write&#8221; a directory, and it&#8217;ll call <cite>mkdir</cite>.  You
can specify a uid and gid, and it&#8217;ll call <cite>chown</cite>.  You can specify a
<cite>mtime</cite> and <cite>atime</cite>, and it&#8217;ll call <cite>utimes</cite>.  You can call it a symlink
and provide a <cite>linkpath</cite> and it&#8217;ll call <cite>symlink</cite>.</p>
<p>Note that it won&#8217;t automatically resolve symbolic links.  So, if you
call <cite>fstream.Reader(&#8216;/some/symlink&#8217;)</cite> then you&#8217;ll get an object
that stats and then ends immediately (since it has no data).  To follow
symbolic links, do this: <cite>fstream.Reader({path:&#8217;/some/symlink&#8217;, follow:
true })</cite>.</p>
...
<dt>.Writer({ path: &#8220;path/to/file&#8221;</dt>
<dd>, mode: 0755
, size: 6
})</dd>
</dl>
...
<cite>hellon</cite> into the file, chmod it to 0755, and assert that 6 bytes have
...
<blockquote>
<div><dl class="docutils">
<dt>.Writer({ path: &#8220;path/to/symlink&#8221;</dt>
<dd>, linkpath: &#8221;./file&#8221;
, SymbolicLink: true
...
any truish value will make a symlink, or you can set <cite>type:
&#8216;SymbolicLink&#8217;</cite>, which does the same thing.</p>
...
fstream</p>
<blockquote>
<div>.Reader(&#8220;path/to/dir&#8221;)
.pipe(fstream.Writer(&#8220;path/to/other/dir&#8221;))</div></blockquote>
<p><a href="#id29"><span class="problematic" id="id30">``</span></a><a href="#id31"><span class="problematic" id="id32">`</span></a></p>
<p>This will do like <cite>cp -Rp path/to/dir path/to/other/dir</cite>.  If the other
dir exists and isn&#8217;t a directory, then it&#8217;ll emit an error.  It&#8217;ll also
set the uid, gid, mode, etc. to be identical.  In this way, it&#8217;s more
like <cite>rsync -a</cite> than simply a copy.</p>
