...
<div role="navigation" aria-label="breadcrumbs navigation">
  <ul class="wy-breadcrumbs">
    ...
    <li>&lt;no title&gt;</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../../../../../../../../../../../../../../../_sources/_themes/sphinx_rtd_theme-master/node_modules/grunt-contrib-imagemin/node_modules/imagemin/node_modules/imagemin-jpegtran/node_modules/jpegtran-bin/node_modules/bin-wrapper/node_modules/download/node_modules/request/CONTRIBUTING.txt" rel="nofollow"> View page source</a>
  ...
  <p># This is an OPEN Open Source Project</p>
<hr class="docutils" />
<p>## What?</p>
...
<p>1. <strong>No `&#8211;force` pushes</strong> or modifying the Git history in any way.
1. <strong>Non-master branches</strong> ought to be used for ongoing work.
1. <strong>External API changes and significant modifications</strong> ought to be subject</p>
<blockquote>
<div>to an <strong>internal pull-request</strong> to solicit feedback from other contributors.</div></blockquote>
...
<p>1. Contributors should attempt to adhere to the prevailing code-style.
1. Run <cite>npm test</cite> locally before submitting your PR, to catch any easy to miss</p>
<blockquote>
<div><p>style &amp; testing issues.  To diagnose test failures, there are two ways to
run a single test file:</p>
<blockquote>
<div><ul class="simple">
<li><cite>node_modules/.bin/taper tests/test-file.js</cite> - run using the default
[<cite>taper</cite>](<a class="reference external" href="https://github.com/nylen/taper">https://github.com/nylen/taper</a>) test reporter.</li>
<li><cite>node tests/test-file.js</cite> - view the raw
[tap](<a class="reference external" href="https://testanything.org/">https://testanything.org/</a>) output.</li>
</ul>
</div></blockquote>
</div></blockquote>
<p>## Releases</p>
