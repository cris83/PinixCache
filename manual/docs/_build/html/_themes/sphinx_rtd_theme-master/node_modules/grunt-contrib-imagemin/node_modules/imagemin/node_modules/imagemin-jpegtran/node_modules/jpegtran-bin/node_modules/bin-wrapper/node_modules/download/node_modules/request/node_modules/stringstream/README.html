  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>})</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../../../../../../../../../../../../../../../../../_sources/_themes/sphinx_rtd_theme-master/node_modules/grunt-contrib-imagemin/node_modules/imagemin/node_modules/imagemin-jpegtran/node_modules/jpegtran-bin/node_modules/bin-wrapper/node_modules/download/node_modules/request/node_modules/stringstream/README.txt" rel="nofollow"> View page source</a>
...
<dl class="docutils">
<dt>var utf8Stream = fs.createReadStream(&#8216;massiveLogFile.gz&#8217;)</dt>
<dd>.pipe(zlib.createGunzip())
.pipe(strs(&#8216;utf8&#8217;))</dd>
</dl>
<p><a href="#id5"><span class="problematic" id="id6">``</span></a><a href="#id7"><span class="problematic" id="id8">`</span></a></p>
<p>No need to deal with <cite>setEncoding()</cite> weirdness, just compose streams
...
var hex64Stream = fs.createReadStream(&#8216;myFile&#8217;)</p>
<blockquote>
<div>.pipe(strs(&#8216;utf8&#8217;, &#8216;hex&#8217;))
.pipe(strs(&#8216;hex&#8217;, &#8216;base64&#8217;))</div></blockquote>
<p><a href="#id13"><span class="problematic" id="id14">``</span></a><a href="#id15"><span class="problematic" id="id16">`</span></a></p>
<p>Also deals with <cite>base64</cite> output correctly by aligning each emitted data
chunk so that there are no dangling <cite>=</cite> characters:</p>
...
stream.on(&#8216;end&#8217;, function() {</p>
<blockquote>
<div>console.log(&#8216;My base64 encoded file is: &#8216; + base64Str) // Wouldn&#8217;t work with setEncoding()
console.log(&#8216;Original file is: &#8216; + new Buffer(base64Str, &#8216;base64&#8217;))</div></blockquote>
