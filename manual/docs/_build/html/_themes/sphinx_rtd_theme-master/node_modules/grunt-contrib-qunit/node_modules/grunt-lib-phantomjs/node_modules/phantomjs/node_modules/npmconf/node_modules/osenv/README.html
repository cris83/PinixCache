  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>})</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../../../../../../../../../../../_sources/_themes/sphinx_rtd_theme-master/node_modules/grunt-contrib-qunit/node_modules/grunt-lib-phantomjs/node_modules/phantomjs/node_modules/npmconf/node_modules/osenv/README.txt" rel="nofollow"> View page source</a>
...
var h = osenv.hostname(function (er, hostname) {</p>
<blockquote>
<div>h = hostname</div></blockquote>
<p>})
...
osenv.hostname(function (er, hostname) {</p>
<blockquote>
<div>if (er) console.error(&#8216;error looking up hostname&#8217;)
else console.log(&#8216;this machine calls itself %s&#8217;, hostname)</div></blockquote>
<div class="section" id="id5">
<h1>})<a class="headerlink" href="#id5" title="Permalink to this headline">¶</a></h1>
<p>## osenv.hostname()</p>
<p>The machine name.  Calls <cite>hostname</cite> if not found.</p>
<p>## osenv.user()</p>
<p>The currently logged-in user.  Calls <cite>whoami</cite> if not found.</p>
<p>## osenv.prompt()</p>
...
and VISUAL environment variables, and falls back to <cite>vi</cite> on Unix, or
<cite>notepad.exe</cite> on Windows.</p>
<p>## osenv.shell()</p>
