  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>&lt;no title&gt;</li>
      <li class="wy-breadcrumbs-aside">
            ...
            <a href="../../../../../../../../../../../../_sources/_themes/sphinx_rtd_theme-master/node_modules/grunt-contrib-yuidoc/node_modules/yuidocjs/node_modules/yui/node_modules/request/node_modules/http-signature/http_signing.txt" rel="nofollow"> View page source</a>
...
<blockquote>
<div><p>credentials := &#8220;Signature&#8221; params digitalSignature
...
<p>The <cite>digitalSignature</cite> portion of the credentials is a REQUIRED field, and is
...
then signed with the key associated with <cite>keyId</cite> and the algorithm corresponding
to <cite>algorithm</cite>.  The result is then <cite>Base64</cite> encoded.</p>
<p>### Signing String Composition</p>
<p>In order to generate the string that is signed with a key, the client MUST
take the values of each HTTP header specified by <cite>headers</cite>, in the order they
appear, and separate with an ASCII newline <cite>n</cite>.  The last header in the list
MUST NOT include a trailing ASCII newline.</p>
...
<blockquote>
<div>Authorization: Signature keyId=&#8221;123&#8221; Base64(RSA-SHA256(Tue, 07 Jun 2011 20:51:35 GMT))</div></blockquote>
<p>## Header List</p>
<blockquote>
<div>Authorization: Signature keyId=&#8221;123&#8221;,headers=&#8221;content-type Date content-md5&#8221; Base64(RSA-SHA256(Tue, 07 Jun 2011 20:51:35 GMT))</div></blockquote>
<p>The client would compose the signing string as (<cite>+ &#8220;n&#8221;</cite> inserted for
readability):</p>
<blockquote>
<div>application/json + &#8220;n&#8221;
Tue, 07 Jun 2011 20:51:35 GMT + &#8220;n&#8221;
h0auK8hnYJKmHTLhKtMTkQ==</div></blockquote>
<p>## Algorithm</p>
<blockquote>
<div>Authorization: Signature keyId=&#8221;123&#8221;,algorithm=&#8221;hmac-sha1&#8221; Base64(HMAC-SHA1(Tue, 07 Jun 2011 20:51:35 GMT))</div></blockquote>
...
<span class="pre">Thu,</span> <span class="pre">05</span> <span class="pre">Jan</span> <span class="pre">2012</span> <span class="pre">21:31:40</span> <span class="pre">GMT</span>
<span class="pre">`</span></code></p>
<p>The Authorization header would be:</p>
<blockquote>
<div>Authorization: Signature keyId=&#8221;Test&#8221;,algorithm=&#8221;rsa-sha256&#8221; MDyO5tSvin5FBVdq3gMBTwtVgE8U/JpzSwFvY7gu7Q2tiZ5TvfHzf/RzmRoYwO8PoV1UGaw6IMwWzxDQkcoYOwvG/w4ljQBBoNusO/mYSvKrbqxUmZi8rNtrMcb82MS33bai5IeLnOGl31W1UbL4qE/wL8U9wCPGRJlCFLsTgD8=</div></blockquote>
<p>### All Headers</p>
<p>Parameterized to include all headers, the string to sign would be:</p>
<p><code class="docutils literal"><span class="pre">`</span>
<span class="pre">/foo?param=value&amp;pet=dog</span> <span class="pre">HTTP/1.1</span>
<span class="pre">example.com</span>
<span class="pre">Thu,</span> <span class="pre">05</span> <span class="pre">Jan</span> <span class="pre">2012</span> <span class="pre">21:31:40</span> <span class="pre">GMT</span>
<span class="pre">application/json</span>
<span class="pre">Sd/dVLAcvNLSq16eXua5uQ==</span>
<span class="pre">18</span>
<span class="pre">`</span></code></p>
<p>The Authorization header would be:</p>
<blockquote>
<div>Authorization: Signature
keyId=&#8221;Test&#8221;,algorithm=&#8221;rsa-sha256&#8221;,headers=&#8221;request-line host date content-type content-md5 content-length&#8221; gVrKP7wVh1+FmWbNlhj0pNXIe9XmeOA6EcnoOKAvUILnwaMFzaKaam9UmeDPwjC9TdT+jSRqjtyZE49kZcSpYAHxGlPQ4ziXFRfPprlN/3Xwg3sUOGqbBiS3WFuY3QOOWv4tzc5p70g74U/QvHNNiYMcjoz89vRJhefbFSNwCDs=</div></blockquote>
